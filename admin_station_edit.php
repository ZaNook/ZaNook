...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "from_add")) {
  $updateSQL = sprintf("UPDATE member SET id=%s, name=%s, user=%s, pass=%s, mail=%s, tel=%s WHERE id=%s",
  ...
  $updateGoTo = "admin_login_success.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div data-role="content"> 
   ...
   <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="from_add">
     <div data-role="fieldcontain">
       ...
       <input type="text" name="id" id="id" value="<?php echo $row_Rs_member['id']; ?>"  />
     </div>
     
     <div data-role="fieldcontain">
       <label for="textinput">ชื่อ:</label>
       <input type="text" name="name" id="name" value="<?php echo $row_Rs_member['name']; ?>"  />
     </div>
     
      <div data-role="fieldcontain">
       <label for="textinput">Username:</label>
       <input type="text" name="user" id="user" value="<?php echo $row_Rs_member['user']; ?>"  />
     </div>
     
      <div data-role="fieldcontain">
       <label for="textinput">Password:</label>
       <input type="text" name="pass" id="pass" value="<?php echo $row_Rs_member['pass']; ?>"  />
     </div>
     
       <div data-role="fieldcontain">
       <label for="textinput">E-mail:</label>
       <input type="text" name="mail" id="mail" value="<?php echo $row_Rs_member['mail']; ?>"  />
     </div>
   
      <div data-role="fieldcontain">
       <label for="textinput">เบอร์โทร:</label>
       <input type="text" name="tel" id="tel" value="<?php echo $row_Rs_member['tel']; ?>"  />
     </div>
      
      <button data-icon="star">แก้ไข</button>
      <input name="id" type="hidden" value="<?php echo $row_Rs_member['id']; ?>" />
      <input type="hidden" name="MM_update" value="from_add" />
   </form>
