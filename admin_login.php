...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "admin_login_success.php";
  $MM_redirectLoginFailed = "admin_login_fail.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_connect_db1, $connect_db1);
  
  $LoginRS__query=sprintf("SELECT admin_user, admin_password FROM tw_admin WHERE admin_user=%s AND admin_password=%s",
